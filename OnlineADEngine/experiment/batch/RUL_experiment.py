    ...
    def execute(self) -> dict:
        ...
        def optimization_objective(**params: dict):
            ...
            with mlflow.start_run(experiment_id=self.experiment_id) as parent_run:
                ...
                mlflow.log_metric("inference_time", inference_time_end - inference_time_start)
                best_metrics_dict = self.rul_evaluate(result_scores, result_dates,result_labels, plot_rul_dictionary,end_with_failure)
