...
def run_train_val_test(dataset,test_dataset,method_class,param_space_dict_per_method,method_name,
                           ...
                           additional_params={},debug=False,datasetname=""):
    ...
    if pre_run is not None:
        ...
        params=run_experiment(dataset, methods, param_space_dict_per_method, method_names,
                                            ...
                                            MAX_RUNS=20, MAX_JOBS=1, INITIAL_RANDOM=1,optimization_param="IBS",
    ...
    run_experiment(test_dataset, methods, [test_params], method_names,
                   ...
                   MAX_RUNS=1, MAX_JOBS=1, INITIAL_RANDOM=1, optimization_param="IBS", debug=True, maximize=False)



def experiment_(method_name,load_dataset_surv,datasetname):
    dataset, test_dataset = load_dataset_surv(keep_identifiers=to_keep_identifiers[method_name])
    ...
    run_train_val_test(dataset, test_dataset, method_class, param_space_dict_per_method, method_name,
                       preprocessor=None, pre_run=None, thresholder=None,datasetname=datasetname)
...
if __name__ == "__main__":
    ...
    from utils import load_HNEI_SA

    args = parse_args()

    if args.dataset == "Azure":
        experiment_(method_name=args.method_name, load_dataset_surv=read_azure, datasetname="Azure")
    elif args.dataset == "SCANIA":
        experiment_(method_name=args.method_name, load_dataset_surv=load_SACNIA_surv, datasetname="SCANIA")
    elif args.dataset == "HNEI":
        experiment_(method_name=args.method_name, load_dataset_surv=load_HNEI_SA, datasetname="HNEI")
